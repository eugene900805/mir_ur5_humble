# MiR100 + UR5 + FT300 + Robotiq Wrist Camera + D435i + Robotiq85 — Isaac Sim back-end (replaces Gazebo).
#
...
def generate_launch_description():
    ...
    # ------------------------------------------------------ robot_description
    # Full robot (MiR base + UR + FT300 + Wrist Camera + D435i + gripper) with Isaac hardware
