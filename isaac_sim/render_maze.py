...
stg.add_reference_to_stage(os.path.join(_HERE, "usd", "maze.usd"), "/World/Env")
stg.add_reference_to_stage(os.path.join(_HERE, "usd", "mir_isaac.usd"), "/World/Robot")
...
Image.fromarray(arr).save(os.path.join(_HERE, "maze_render.png"))
